...
@pytest.mark.asyncio
async def test_sub_account_futures_position_risk_v2_without_email():
    ...
    try:
        response = await client.sub_account_futures_position_risk(**params)
...
@pytest.mark.asyncio
async def test_sub_account_futures_position_risk_v2_without_futuresType():
...
@mock_async_http_response(
    "GET",
    "/sapi/v2/sub-account/futures/positionRisk\\?" + encoded_string(params, True),
    mock_item,
    200,
)
async def test_sub_account_futures_position_risk_v2():
