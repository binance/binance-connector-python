...
def test_sub_account_futures_account_summary_v2_without_futuresType():
    ...
    client.sub_account_futures_account_summary_v2.when.called_with(**params).should.throw(ParameterRequiredError)
...
def test_sub_account_futures_account_summary_v2():
    ...
    client = Client(key, secret)
    response = client.sub_account_futures_account_summary_v2(futuresType=1)
