...
def test_sub_account_deposit_address_without_email():
    ...
    client.sub_account_deposit_address.when.called_with(
...
@mock_http_response(responses.GET, '/sapi/v1/capital/deposit/subAddress\\?' + encoded_string(params), mock_item, 200)
