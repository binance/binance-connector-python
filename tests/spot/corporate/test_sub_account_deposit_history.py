...
def test_sub_account_deposit_history_without_email():
    ...
    client.sub_account_deposit_history.when.called_with(
        **params).should.throw(ParameterRequiredError)


@mock_http_response(responses.GET, '/sapi/v1/capital/deposit/subHisrec\\?' + encoded_string(params), mock_item, 200)
