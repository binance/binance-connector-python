...
def test_sub_account_universal_transfer_without_fromAccountType():
    ...
    client.sub_account_universal_transfer.when.called_with(**params).should.throw(ParameterRequiredError)
...
@mock_http_response(responses.POST, '/sapi/v1/sub-account/universalTransfer\\?' + encoded_string(params), mock_item, 200)
