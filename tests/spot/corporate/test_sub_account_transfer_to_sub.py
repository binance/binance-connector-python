...
def test_sub_account_transfer_to_sub_without_toEmail():
    ...
    client.sub_account_transfer_to_sub.when.called_with(
...
@mock_http_response(responses.POST, '/sapi/v1/sub-account/transfer/subToSub\\?' + encoded_string(params), mock_item, 200)
