...
def test_sub_account_margin_transfer_without_email():
    ...
    client.sub_account_margin_transfer.when.called_with(
...
@mock_http_response(responses.POST, '/sapi/v1/sub-account/margin/transfer\\?' + encoded_string(params), mock_item, 200)
