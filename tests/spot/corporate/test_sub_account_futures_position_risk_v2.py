...
def test_sub_account_futures_position_risk_v2_without_email():
    ...
    client.sub_account_futures_position_risk_v2.when.called_with(**params).should.throw(ParameterRequiredError)
...
def test_sub_account_futures_position_risk_v2():
    ...
    client = Client(key, secret)
    response = client.sub_account_futures_position_risk_v2(**params)
