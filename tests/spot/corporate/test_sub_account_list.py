...
@mock_http_response(responses.GET, '/sapi/v1/sub-account/list\\?email=alice@test.com&' + urlencode(params), mock_item, 200)
...
@mock_http_response(responses.GET, '/sapi/v1/sub-account/list\\?' + urlencode(params), mock_item, 200)
