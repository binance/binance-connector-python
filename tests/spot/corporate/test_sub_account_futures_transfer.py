...
def test_sub_account_futures_transfer_without_email():
    ...
    client.sub_account_futures_transfer.when.called_with(
...
@mock_http_response(responses.POST, '/sapi/v1/sub-account/futures/transfer\\?' + encoded_string(params), mock_item, 200)
