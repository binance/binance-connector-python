...
def test_new_isolated_margin_listen_key_without_symbol():
    ...
    client.new_isolated_margin_listen_key.when.called_with('').should.throw(ParameterRequiredError)
 

@mock_http_response(responses.POST, '/sapi/v1/userDataStream/isolated\\?symbol=BTCUSDT', mock_item, 200)
