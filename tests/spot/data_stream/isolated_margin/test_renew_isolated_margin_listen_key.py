...
def test_renew_isolated_margin_listen_key_without_symbol():
    ...
    client.renew_isolated_margin_listen_key.when.called_with(**param).should.throw(ParameterRequiredError)
...
@mock_http_response(responses.PUT, '/sapi/v1/userDataStream/isolated\\?listenKey='+ listen_key + '&symbol=BTCUSDT', mock_item, 200)
