...
def test_mining_hashrate_resale_cancellation_with_missing_field(params):
    ...
    client.mining_hashrate_resale_cancellation.when.called_with(**params).should.throw(ParameterRequiredError)


@mock_http_response(responses.POST, '/sapi/v1/mining/hash-transfer/config/cancel\\?configId=123&userName=user_name',
                    mock_item, 200)
