...
def test_mining_hashrate_resale_details_with_missing_field(params):
    ...
    client.mining_hashrate_resale_details.when.called_with(**params).should.throw(ParameterRequiredError)


@mock_http_response(responses.GET, '/sapi/v1/mining/hash-transfer/profit/details\\?configId=123&userName=user_name',
                    mock_item, 200)
