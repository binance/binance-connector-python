...
def test_futures_loan_collateral_repay_result_without_quoteId():
    ...
    client.futures_loan_collateral_repay_result.when.called_with(**params).should.throw(ParameterRequiredError)


@mock_http_response(responses.GET, '/sapi/v1/futures/loan/collateralRepayResult\\?' + urlencode(params), mock_item, 200)
