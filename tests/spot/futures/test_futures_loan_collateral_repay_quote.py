...
def test_futures_loan_collateral_repay_quote_without_coin():
    ...
    client.futures_loan_collateral_repay_quote.when.called_with(**params).should.throw(ParameterRequiredError)
...
@mock_http_response(responses.GET, '/sapi/v1/futures/loan/collateralRepay\\?' + urlencode(params), mock_item, 200)
