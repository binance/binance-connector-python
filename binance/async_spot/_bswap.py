...
async def bswap_swap(self, quoteAsset: str, baseAsset: str, quoteQty: float, **kwargs):
    ...
    return await self.sign_request("POST", "/sapi/v1/bswap/swap", payload)
...
async def bswap_swap_history(self, **kwargs):
    ...
    Keyword Args:
        ...
        recvWindow (int, optional): The value cannot be greater than 60000
    """
    return await self.sign_request("GET", "/sapi/v1/bswap/swap", kwargs)
...
async def bswap_pool_configure(self, **kwargs):
    ...
    Keyword Args:
        ...
        recvWindow (int, optional): The value cannot be greater than 60000
    """
    return await self.sign_request("GET", "/sapi/v1/bswap/poolConfigure", kwargs)
...
async def bswap_add_liquidity_preview(
    ...
    return await self.sign_request("GET", "/sapi/v1/bswap/addLiquidityPreview", payload)
...
async def bswap_remove_liquidity_preview(
    ...
    return await self.sign_request("GET", "/sapi/v1/bswap/removeLiquidityPreview", payload)
...
async def bswap_unclaimed_rewards(self, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/bswap/unclaimedRewards", kwargs)
...
async def bswap_claim_rewards(self, **kwargs):
    ...
    return await self.sign_request("POST", "/sapi/v1/bswap/claimRewards", kwargs)
...
async def bswap_claimed_rewards(self, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/bswap/claimedHistory", kwargs)
