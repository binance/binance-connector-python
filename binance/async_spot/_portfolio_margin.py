...
async def portfolio_margin_collateral_rate(self):
    ...
    return await self.sign_request("GET", url_path)


async def portfolio_margin_bankruptcy_loan_amount(self, **kwargs):
...
async def portfolio_margin_bankruptcy_loan_repay(self, **kwargs):
