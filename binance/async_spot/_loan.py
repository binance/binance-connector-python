...
async def loan_history(self, asset: str, **kwargs):
    ...
    Keyword Args:
      type (str, optional): All types will be returned by default.
                            borrowIn, collateralSpent, repayAmount, collateralReturn await (collateral return await after repayment),
...
async def loan_borrow(self, loanCoin: str, collateralCoin: str, loanTerm: int, **kwargs):
    ...
    return await self.sign_request("POST", "/sapi/v1/loan/borrow", payload)


async def loan_borrow_history(self, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/loan/borrow/history", kwargs)


async def loan_ongoing_orders(self, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/loan/ongoing/orders", kwargs)


async def loan_repay(self, orderId: int, amount: float, **kwargs):
    ...
    Keyword Args:
      ...
      collateralReturn await (boolean, optional): Default: TRUE. TRUE: Return await extra collateral to spot account; FALSE: Keep extra collateral in the order.
      recvWindow (int, optional): The value cannot be greater than 60000
    """
    ...
    return await self.sign_request("POST", "/sapi/v1/loan/repay", payload)


async def loan_repay_history(self, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/loan/repay/history", kwargs)


async def loan_adjust_ltv(self, orderId: int, amount: float, direction: str, **kwargs):
    ...
    return await self.sign_request("POST", "/sapi/v1/loan/adjust/ltv", payload)


async def loan_adjust_ltv_history(self, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/loan/ltv/adjustment/history", kwargs)


async def loan_vip_ongoing_orders(self, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/loan/vip/ongoing/orders", kwargs)


async def loan_vip_repay(self, orderId: int, amount: float, **kwargs):
    ...
    payload = {"orderId": orderId, "amount": amount, **kwargs}
    return await self.sign_request("POST", "/sapi/v1/loan/vip/repay", payload)


async def loan_vip_repay_history(self, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/loan/vip/repay/history", kwargs)


async def loan_vip_collateral_account(self, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/loan/vip/collateral/account", kwargs)


async def loan_loanable_data(self, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/loan/loanable/data", kwargs)


async def loan_collateral_data(self, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/loan/collateral/data", kwargs)


async def loan_collateral_rate(
    ...
    return await self.sign_request("GET", "/sapi/v1/loan/repay/collateral/rate", payload)


async def loan_customize_margin_call(self, marginCall: float, **kwargs):
    ...
    return await self.sign_request("POST", "/sapi/v1/loan/customize/margin_call", payload)
