...
async def gift_card_create_code(self, token: str, amount: float, **kwargs):
    ...
    return await self.sign_request("POST", "/sapi/v1/giftcard/createCode", payload)


async def gift_card_redeem_code(self, code: str, **kwargs):
    ...
    return await self.sign_request("POST", "/sapi/v1/giftcard/redeemCode", payload)


async def gift_card_verify_code(self, referenceNo: str, **kwargs):
    ...
    return await self.sign_request("GET", "/sapi/v1/giftcard/verify", payload)


async def gift_card_rsa_public_key(self, **kwargs):
...
async def gift_card_buy_code(
    ...
    return await self.sign_request("POST", "/sapi/v1/giftcard/buyCode", payload)


async def gift_card_token_limit(self, baseToken: str, **kwargs):
