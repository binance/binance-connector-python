...
class SpotWebsocketClient(BinanceWebsocketClient):
    ...
    def agg_trade(self, symbol: str, id: int, callback, **kwargs):
        ...
        """
        self.live_subscribe('{}@aggTrade'.format(symbol.lower()), id, callback, **kwargs)
    ...
    def kline(self, symbol: str,  id: int, interval: str, callback, **kwargs):
        ...
        self.live_subscribe('{}@kline_{}'.format(symbol.lower(), interval), id, callback, **kwargs)
    ...
    def mini_ticker(self, id: int, callback, symbol=None, **kwargs):
        ...
        if symbol is None:
            ...
            self.live_subscribe('{}@miniTicker'.format(symbol.lower()), id, callback, **kwargs)
    ...
    def ticker(self, id: int, callback, symbol=None, **kwargs):
        ...
        if symbol is None:
            ...
            self.live_subscribe('{}@ticker'.format(symbol.lower()), id, callback, **kwargs)
    ...
    def book_ticker(self, id: int, callback, symbol=None, **kwargs):
        ...
        if symbol is None:
            ...
            self.live_subscribe('{}@bookTicker'.format(symbol.lower()), id, callback, **kwargs)
    ...
    def partial_book_depth(self, symbol: str, id: int, level, speed, callback, **kwargs):
        ...
        """
        self.live_subscribe('{}@depth{}@{}ms'.format(symbol.lower(), level, speed), id, callback, **kwargs)
    ...
    def diff_book_depth(self, symbol: str, id: int, speed, callback, **kwargs):
        ...
        """
        self.live_subscribe('{}@depth@{}ms'.format(symbol.lower(), speed),  id, callback, **kwargs)
