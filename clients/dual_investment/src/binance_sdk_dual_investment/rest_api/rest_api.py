    ...
    def get_dual_investment_product_list(
        ...
        Weight(IP): 1
                ...
                Args:
                    ...
                    exercised_coin (Union[str, None]): Target exercised asset, e.g.: if you subscribe to a high sell product (call option), you should input:
        ...
        option), you should input: `optionType: PUT`, `exercisedCoin: BNB`, `investCoin: USDT`
                    invest_coin (Union[str, None]): Asset used for subscribing, e.g.: if you subscribe to a high sell product (call option), you should input:
        `optionType: CALL`, `exercisedCoin: USDT`, `investCoin: BNB`; if you subscribe to a low buy product (put
        option), you should input: `optionType: PUT`, `exercisedCoin: BNB`, `investCoin: USDT`
