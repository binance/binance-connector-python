...
class TestFiatApi:
    ...
    def test_fiat_withdraw_success(self, mock_get_signature):
        ...
        response = self.client.fiat_withdraw()
    ...
    def test_get_order_detail_missing_required_param_order_id(self):
        """Test that get_order_detail() raises RequiredError when 'order_id' is missing."""
        params = {
            "order_id": "1",
        }
