...
class QueryLimitOpenOrdersResponseListInner(BaseModel):
    """
    ...
    expired_timestamp: Optional[StrictInt] = Field(
        default=None, alias="expiredTimestamp"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryLimitOpenOrdersResponseListInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryLimitOpenOrdersResponseListInner from a dict"""
        if obj is None:
            return None
