# Binance Python Derivatives Trading (Options) Connector

[![Build Status](https://img.shields.io/github/actions/workflow/status/binance/binance-connector-python/ci-derivatives-trading-options.yml)](https://github.com/binance/binance-connector-python/actions)
...
[![PyPI version](https://img.shields.io/pypi/v/binance-derivatives-trading-options)](https://pypi.python.org/pypi/binance-derivatives-trading-options)
[![PyPI Downloads](https://img.shields.io/pypi/dm/binance-derivatives-trading-options.svg)](https://pypi.org/project/binance-derivatives-trading-options/)
...
- [REST API](./src/binance_derivatives_trading_options/rest_api/rest_api.py)
- [WebSocket Stream](./src/binance_derivatives_trading_options/websocket_streams/websocket_streams.py)
...
All REST API endpoints are available through the [`rest_api`](./src/binance_derivatives_trading_options/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Binance API credentials.
...
WebSocket Streams provide real-time data feeds for market trades, candlesticks, and more. Use the [websocket-streams](./src/binance_derivatives_trading_options/websocket_streams/websocket_streams.py) module to subscribe to these streams.
...
If you are upgrading to the new modularized structure, refer to the [Migration Guide](./docs/migration_guide_derivatives_trading_options_connector.md) for detailed steps.
