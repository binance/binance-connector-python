...
class GetSubAccountDepositHistoryResponseInner(BaseModel):
    """
    ...
    status: Optional[StrictInt] = Field(
        default=None,
        description="Deposit status: 0=pending, 6=credited but cannot withdraw, 7=wrong deposit, 8=waiting user confirmation, 1=success.",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSubAccountDepositHistoryResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSubAccountDepositHistoryResponseInner from a dict"""
        if obj is None:
            return None
