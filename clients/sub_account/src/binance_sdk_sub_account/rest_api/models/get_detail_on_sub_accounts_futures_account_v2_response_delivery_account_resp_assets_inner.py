...
class GetDetailOnSubAccountsFuturesAccountV2ResponseDeliveryAccountRespAssetsInner(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDetailOnSubAccountsFuturesAccountV2ResponseDeliveryAccountRespAssetsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDetailOnSubAccountsFuturesAccountV2ResponseDeliveryAccountRespAssetsInner from a dict"""
        if obj is None:
            return None
