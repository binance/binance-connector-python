...
class GetFuturesPositionRiskOfSubAccountV2ResponseDeliveryPositionRiskVosInner(
    ...
    isolated: Optional[StrictStr] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetFuturesPositionRiskOfSubAccountV2ResponseDeliveryPositionRiskVosInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetFuturesPositionRiskOfSubAccountV2ResponseDeliveryPositionRiskVosInner from a dict"""
        if obj is None:
            return None
