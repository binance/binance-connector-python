...
class QueryUniversalTransferHistoryResponseResultInner(BaseModel):
    """
    ...
    create_time_stamp: Optional[StrictInt] = Field(
        default=None, alias="createTimeStamp"
    )
    from_account_type: Optional[StrictStr] = Field(
        default=None, alias="fromAccountType"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryUniversalTransferHistoryResponseResultInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryUniversalTransferHistoryResponseResultInner from a dict"""
        if obj is None:
            return None
