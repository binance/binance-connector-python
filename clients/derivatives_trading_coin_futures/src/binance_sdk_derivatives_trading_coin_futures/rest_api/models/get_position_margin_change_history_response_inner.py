...
class GetPositionMarginChangeHistoryResponseInner(BaseModel):
    """
    ...
    type: Optional[StrictInt] = Field(default=None, description="Order type.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetPositionMarginChangeHistoryResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetPositionMarginChangeHistoryResponseInner from a dict"""
        if obj is None:
            return None
