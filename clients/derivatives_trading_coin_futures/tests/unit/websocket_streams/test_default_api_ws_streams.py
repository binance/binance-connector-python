...
class TestWebSocketStreams:
    ...
    @pytest.mark.asyncio
    async def test_market_liquidation_order_streams_subscription(self):
        """Test that market_liquidation_order_streams() subscribes to the correct WebSocket stream."""
