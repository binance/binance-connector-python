...
from binance_sdk_margin_trading.rest_api.models.query_isolated_margin_account_info_response_assets_inner import (
...
class QueryIsolatedMarginAccountInfoResponse(BaseModel):
    ...
    assets: Optional[List[QueryIsolatedMarginAccountInfoResponseAssetsInner]] = None
