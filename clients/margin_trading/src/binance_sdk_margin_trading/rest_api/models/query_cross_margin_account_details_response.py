...
from binance_sdk_margin_trading.rest_api.models.query_cross_margin_account_details_response_user_assets_inner import (
...
class QueryCrossMarginAccountDetailsResponse(BaseModel):
    ...
    collateral_margin_level: Optional[StrictStr] = Field(
        default=None, alias="collateralMarginLevel"
    )
