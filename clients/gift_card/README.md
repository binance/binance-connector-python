...
[![Python version](https://img.shields.io/pypi/pyversions/binance-sdk-gift-card)](https://www.python.org/downloads/)
...
For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/docs/gift_card/Introduction).
