...
from binance_derivatives_trading_usds_futures.rest_api.models.symbol_order_book_ticker_response1 import (
    SymbolOrderBookTickerResponse1,
)
from binance_derivatives_trading_usds_futures.rest_api.models.symbol_order_book_ticker_response2 import (
