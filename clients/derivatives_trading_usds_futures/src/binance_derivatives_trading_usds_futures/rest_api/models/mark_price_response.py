...
from binance_derivatives_trading_usds_futures.rest_api.models.mark_price_response1 import (
    MarkPriceResponse1,
)
from binance_derivatives_trading_usds_futures.rest_api.models.mark_price_response2 import (
    MarkPriceResponse2,
)
