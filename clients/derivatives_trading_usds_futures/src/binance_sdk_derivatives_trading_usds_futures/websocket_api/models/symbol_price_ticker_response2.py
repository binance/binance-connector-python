...
from binance_sdk_derivatives_trading_usds_futures.websocket_api.models.symbol_price_ticker_response1_result import (
...
class SymbolPriceTickerResponse2(BaseModel):
    ...
    result: Optional[List[SymbolPriceTickerResponse1Result]] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        SymbolPriceTickerResponse1Result.from_dict(_item)
