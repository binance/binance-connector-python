...
class QueryOrderResponseResult(BaseModel):
    """
    ...
    good_till_date: Optional[StrictInt] = Field(
        default=None, description="Order good till date timestamp", alias="goodTillDate"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryOrderResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryOrderResponseResult from a dict"""
        if obj is None:
            return None
