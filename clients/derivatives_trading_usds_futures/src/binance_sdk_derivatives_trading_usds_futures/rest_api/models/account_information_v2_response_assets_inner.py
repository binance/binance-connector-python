...
class AccountInformationV2ResponseAssetsInner(BaseModel):
    """
    ...
    maint_margin: Optional[StrictStr] = Field(
        default=None, description="Maintenance margin requirement.", alias="maintMargin"
    )
    ...
    cross_wallet_balance: Optional[StrictStr] = Field(
        default=None, description="Cross wallet balance.", alias="crossWalletBalance"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountInformationV2ResponseAssetsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountInformationV2ResponseAssetsInner from a dict"""
        if obj is None:
            return None
