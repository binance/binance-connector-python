...
class QueryAlgoOrderResponse(BaseModel):
    """
    ...
    actual_order_id: Optional[StrictStr] = Field(
        default=None,
        description="Empty string if not triggered; orderId if triggered.",
        alias="actualOrderId",
    )
    actual_price: Optional[StrictStr] = Field(
        default=None,
        description="0 if not triggered; average price if filled/partially filled.",
        alias="actualPrice",
    )
    actual_type: Optional[StrictStr] = Field(
        default=None,
        description="Optional field, only present when triggered.",
        alias="actualType",
    )
    actual_qty: Optional[StrictStr] = Field(
        default=None,
        description="Optional field, only present when filled/partially filled.",
        alias="actualQty",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryAlgoOrderResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryAlgoOrderResponse from a dict"""
        if obj is None:
            return None
