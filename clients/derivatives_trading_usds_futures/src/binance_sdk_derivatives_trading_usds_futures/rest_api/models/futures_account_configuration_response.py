...
class FuturesAccountConfigurationResponse(BaseModel):
    """
    ...
    dual_side_position: Optional[StrictBool] = Field(
        default=None, alias="dualSidePosition"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FuturesAccountConfigurationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FuturesAccountConfigurationResponse from a dict"""
        if obj is None:
            return None
