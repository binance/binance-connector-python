...
from binance_sdk_derivatives_trading_usds_futures.rest_api.models.account_information_v2_response_assets_inner import (
    AccountInformationV2ResponseAssetsInner,
)
from binance_sdk_derivatives_trading_usds_futures.rest_api.models.account_information_v2_response_positions_inner import (
...
class AccountInformationV2Response(BaseModel):
    ...
    assets: Optional[List[AccountInformationV2ResponseAssetsInner]] = None
    positions: Optional[List[AccountInformationV2ResponsePositionsInner]] = None
