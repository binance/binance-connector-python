...
from binance_sdk_derivatives_trading_usds_futures.rest_api.models.continuous_contract_kline_candlestick_data_response_item import (
...
class ContinuousContractKlineCandlestickDataResponse(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContinuousContractKlineCandlestickDataResponse from a JSON string"""
