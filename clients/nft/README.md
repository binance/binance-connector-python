# Binance Python NFT Connector

[![Build Status](https://img.shields.io/github/actions/workflow/status/binance/binance-connector-python/ci-nft.yml)](https://github.com/binance/binance-connector-python/actions)
...
[![PyPI version](https://img.shields.io/pypi/v/binance-nft)](https://pypi.python.org/pypi/binance-nft)
[![PyPI Downloads](https://img.shields.io/pypi/dm/binance-nft.svg)](https://pypi.org/project/binance-nft/)
...
- [REST API](./src/binance_nft/rest_api/rest_api.py)
...
All REST API endpoints are available through the [`rest_api`](./src/binance_nft/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Binance API credentials.
