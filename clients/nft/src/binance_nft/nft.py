...
from .rest_api import NFTRestAPI
...
class NFT:
    """NFT API that exposes REST APIs in a single interface."""
    ...
    def rest_api(self) -> NFTRestAPI:
        if self._rest_api is None and self._rest_api_config:
            ...
            self._rest_api = NFTRestAPI(self._rest_api_config)
