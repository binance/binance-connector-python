...
from binance_sdk_nft.rest_api.models.get_nft_asset_response_list_inner import (
...
class GetNFTAssetResponse(BaseModel):
    """
    GetNFTAssetResponse
    """  # noqa: E501

    total: Optional[StrictInt] = None
    list: Optional[List[GetNFTAssetResponseListInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetNFTAssetResponse from a JSON string"""
        ...
        _obj = cls.model_validate(
            {
                ...
                "list": (
                    [
                        GetNFTAssetResponseListInner.from_dict(_item)
