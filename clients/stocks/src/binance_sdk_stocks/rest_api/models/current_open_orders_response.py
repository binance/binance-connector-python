...
from binance_sdk_stocks.rest_api.models.current_open_orders_response_inner import (
...
class CurrentOpenOrdersResponse(CurrentOpenOrdersResponseInner):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CurrentOpenOrdersResponse from a JSON string"""
