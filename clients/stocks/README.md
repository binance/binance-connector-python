...
[![PyPI version](https://img.shields.io/pypi/v/binance-sdk-stocks)](https://pypi.python.org/pypi/binance-sdk-stocks)
[![PyPI Downloads](https://img.shields.io/pypi/dm/binance-sdk-stocks.svg)](https://pypi.org/project/binance-sdk-stocks/)
[![Python version](https://img.shields.io/pypi/pyversions/binance-sdk-stocks)](https://www.python.org/downloads/)
...
- [REST API](./src/binance_sdk_stocks/rest_api/rest_api.py)
- [Websocket Stream](./src/binance_sdk_stocks/websocket_streams/websocket_streams.py)
...
```bash
pip install binance-sdk-stocks
```

## Documentation

For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/docs/stocks/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/binance_sdk_stocks/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Binance API credentials.
...
configuration = ConfigurationRestAPI(api_key="your-api-key", api_secret="your-api-secret", base_path=STOCKS_REST_API_PROD_URL)

client = Stocks(config_rest_api=configuration)
...
from binance_common.constants import STOCKS_WS_STREAMS_PROD_URL
from binance_sdk_stocks.stocks import Stocks

logging.basicConfig(level=logging.INFO)

configuration_ws_streams = ConfigurationWebSocketStreams(
    stream_url=STOCKS_WS_STREAMS_PROD_URL,
)
...
client = Stocks(config_ws_streams=ConfigurationWebSocketStreams())
