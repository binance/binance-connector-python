...
from binance_sdk_spot.websocket_api.models.my_filters_response_result import (
...
class MyFiltersResponse(BaseModel):
    ...
    result: Optional[MyFiltersResponseResult] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    MyFiltersResponseResult.from_dict(obj["result"])
