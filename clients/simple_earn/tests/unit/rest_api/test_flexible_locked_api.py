...
from binance_sdk_simple_earn.rest_api.models import SubscribeLockedProductRedeemToEnum
...
class TestFlexibleLockedApi:
    ...
    def test_subscribe_flexible_product_success_with_optional_params(
        ...
        params = {
            ...
            "amount": 1.0,
            "auto_subscribe": True,
            "source_account": SubscribeFlexibleProductSourceAccountEnum["SPOT"].value,
            "recv_window": 5000,
        }
    ...
    def test_subscribe_locked_product_success_with_optional_params(
        ...
        params = {
            ...
            "source_account": SubscribeLockedProductSourceAccountEnum["SPOT"].value,
            "redeem_to": SubscribeLockedProductRedeemToEnum["SPOT"].value,
            "recv_window": 5000,
        }
