...
class TestRwusdApi:
    ...
    def test_get_rwusd_subscription_history_success_with_optional_params(
        ...
        params = {
            "asset": GetRwusdSubscriptionHistoryAssetEnum["USDC"].value,
            "start_time": 1623319461670,
            "end_time": 1641782889000,
            "current": 1,
            "size": 10,
    ...
    def test_subscribe_rwusd_success(self, mock_get_signature):
        ...
        params = {
            "asset": SubscribeRwusdAssetEnum["USDT"].value,
            "amount": 1.0,
        }
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["asset"] == SubscribeRwusdAssetEnum["USDT"].value
        assert normalized["amount"] == 1.0
