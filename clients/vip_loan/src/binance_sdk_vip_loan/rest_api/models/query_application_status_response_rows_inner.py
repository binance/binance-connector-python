...
class QueryApplicationStatusResponseRowsInner(BaseModel):
    ...
    loan_account_id: Optional[StrictStr] = Field(
        default=None, description="Loan receiving account.", alias="loanAccountId"
    )
    ...
    status: Optional[StrictStr] = Field(
        default=None,
        description="Order status (`Accruing_Interest`, `Overdue`, `Liquidating`, `Repaying`, `Repaid`, `Liquidated`, `Pending`, `Failed`).",
    )
