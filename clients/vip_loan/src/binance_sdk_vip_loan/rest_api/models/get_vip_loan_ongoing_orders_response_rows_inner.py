...
class GetVIPLoanOngoingOrdersResponseRowsInner(BaseModel):
    ...
    loan_rate: Optional[StrictStr] = Field(
        default=None,
        description="For flexible loans, this is the flexible rate.",
        alias="loanRate",
    )
    ...
    expiration_time: Optional[StrictInt] = Field(
        default=None,
        description="For flexible loans, this value is `0`.",
        alias="expirationTime",
    )
    loan_date: Optional[StrictStr] = Field(default=None, alias="loanDate")
    loan_term: Optional[StrictStr] = Field(
        default=None,
        description="For flexible loans, this value is `open term`.",
        alias="loanTerm",
    )
