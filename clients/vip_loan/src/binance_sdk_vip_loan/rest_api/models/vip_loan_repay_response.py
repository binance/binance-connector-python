...
class VipLoanRepayResponse(BaseModel):
    """
    ...
    remaining_principal: Optional[StrictStr] = Field(
        default=None, alias="remainingPrincipal"
    )
    remaining_interest: Optional[StrictStr] = Field(
        default=None, alias="remainingInterest"
    )
    ...
    repay_status: Optional[StrictStr] = Field(
        default=None,
        description="Repayment status (`Repaid`, `Repaying`, `Failed`).",
        alias="repayStatus",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VipLoanRepayResponse from a JSON string"""
