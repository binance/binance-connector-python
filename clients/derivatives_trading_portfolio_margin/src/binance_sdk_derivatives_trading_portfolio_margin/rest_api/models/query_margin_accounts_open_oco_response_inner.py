...
from binance_sdk_derivatives_trading_portfolio_margin.rest_api.models.query_margin_accounts_open_oco_response_inner_orders_inner import (
...
class QueryMarginAccountsOpenOcoResponseInner(BaseModel):
    ...
    orders: Optional[List[QueryMarginAccountsOpenOcoResponseInnerOrdersInner]] = None
