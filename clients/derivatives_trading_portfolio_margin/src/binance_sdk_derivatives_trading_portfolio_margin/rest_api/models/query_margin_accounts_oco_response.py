...
from binance_sdk_derivatives_trading_portfolio_margin.rest_api.models.query_margin_accounts_oco_response_orders_inner import (
...
class QueryMarginAccountsOcoResponse(BaseModel):
    ...
    orders: Optional[List[QueryMarginAccountsOcoResponseOrdersInner]] = None
