...
from binance_sdk_derivatives_trading_portfolio_margin.rest_api.models.margin_account_new_oco_response_order_reports_inner import (
    MarginAccountNewOcoResponseOrderReportsInner,
)
from binance_sdk_derivatives_trading_portfolio_margin.rest_api.models.margin_account_new_oco_response_orders_inner import (
...
class MarginAccountNewOcoResponse(BaseModel):
    ...
    orders: Optional[List[MarginAccountNewOcoResponseOrdersInner]] = None
