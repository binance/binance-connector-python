...
class RedeemBfusdForPortfolioMarginResponse(BaseModel):
    """
    ...
    from_asset_qty: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="fromAssetQty"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RedeemBfusdForPortfolioMarginResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RedeemBfusdForPortfolioMarginResponse from a dict"""
        if obj is None:
            return None
