...
class GetPortfolioMarginProAccountBalanceResponseInner(BaseModel):
    ...
    option_wallet_balance: Optional[StrictStr] = Field(
        default=None, alias="optionWalletBalance"
    )
