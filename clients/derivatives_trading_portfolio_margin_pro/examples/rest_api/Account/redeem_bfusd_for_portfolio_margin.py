...
def redeem_bfusd_for_portfolio_margin():
    try:
        response = client.rest_api.redeem_bfusd_for_portfolio_margin(
        ...
        logging.info(f"redeem_bfusd_for_portfolio_margin() rate limits: {rate_limits}")

        data = response.data()
        logging.info(f"redeem_bfusd_for_portfolio_margin() response: {data}")
    except Exception as e:
        logging.error(f"redeem_bfusd_for_portfolio_margin() error: {e}")


if __name__ == "__main__":
    redeem_bfusd_for_portfolio_margin()
